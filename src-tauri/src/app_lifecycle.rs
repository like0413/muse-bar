...
const BAR_VISIBILITY_CHANGED_EVENT: &str = "bar-visibility-changed";
...
pub(crate) fn synchronize_bar_visibility<R: Runtime>(app: &AppHandle<R>) -> Result<(), String> {
    ...
    if should_show {
        ...
        let _ = app.emit_to(BAR_WINDOW_LABEL, BAR_VISIBILITY_CHANGED_EVENT, true);
        ...
        let _ = app.emit_to(BAR_WINDOW_LABEL, BAR_VISIBILITY_CHANGED_EVENT, false);
    }
