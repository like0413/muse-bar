...
pub struct AppSettings {
    ...
    pub artwork_shape: ArtworkShape,
    pub rotate_circular_artwork: bool,
    pub show_progress: bool,
    pub spectrum_mode: SpectrumMode,
    pub spectrum_origin: SpectrumOrigin,
...
impl Default for AppSettings {
    ...
    fn default() -> Self {
        Self {
            ...
            artwork_shape: ArtworkShape::Rounded,
            rotate_circular_artwork: false,
            show_progress: true,
            spectrum_mode: SpectrumMode::Off,
            spectrum_origin: SpectrumOrigin::Bottom,
